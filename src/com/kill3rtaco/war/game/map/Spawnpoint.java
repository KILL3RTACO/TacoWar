...
public class Spawnpoint {
	...
	public boolean appliesTo(int gametype) {
		return appliesTo(gametype, "");
	}
	
	public boolean appliesTo(int gametype, String team) {
		switch (gametype) {
			case GameType.FFA:
				return (_team == null || _team.isEmpty()) && (team == null || team.isEmpty());
			case GameType.TDM:
			case GameType.KOTH:
				return _team != null && !_team.isEmpty() && _team.equals(team);
			default:
				return false;
		}
	}
