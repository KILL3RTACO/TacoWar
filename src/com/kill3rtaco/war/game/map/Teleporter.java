...
public class Teleporter {
	...
	public Location getTeleportLocation(WarPlayer player) {
	...
	public void teleportPlayer(WarPlayer player) {
		teleportPlayer(player, getTeleportLocation(player));
	}

	public void teleportPlayer(WarPlayer player, Location location) {
		Location playerLoc = player.getBukkitPlayer().getLocation();
