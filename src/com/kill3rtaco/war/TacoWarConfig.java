...
public class TacoWarConfig extends TacoConfig {
	...
	public static final String	KEY_CURRENT_PLAYLIST		= "playlist";
	...
	public static final String	DEF_PLAYLIST				= PlaylistDefault.ID;
	...
	protected void setDefaults() {
		addDefaultValue(KEY_CURRENT_PLAYLIST, DEF_PLAYLIST);
	...
	public void setPlaylist(String id) {
		set(KEY_CURRENT_PLAYLIST, id);
	}
	
	public Playlist getCurrentPlaylist() {
		Playlist playlist = TacoWar.getPlaylist(KEY_CURRENT_PLAYLIST);
		if (playlist != null)
			return playlist;
		return TacoWar.getPlaylist(PlaylistDefault.ID);
	}
